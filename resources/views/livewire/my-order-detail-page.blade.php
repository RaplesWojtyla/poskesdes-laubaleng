<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  ...
  <div class="flex justify-between items-center py-5">
    <span class="text-3xl font-bold text-black-500">{{ $orderDetail->invoice_code }}</span>
    @if ($orderDetail->payment_status == 'Pembayaran Gagal')
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-5">
    <!-- Card -->
    <div class="flex flex-col bg-white border shadow-lg rounded-xl dark:bg-slate-900 dark:border-gray-800">
      <div class="p-4 md:p-5 flex gap-x-4">
        <div class="flex-shrink-0 flex justify-center items-center size-[46px] bg-gray-200 rounded-lg dark:bg-gray-800">
    ...
    <!-- Card -->
    <div class="flex flex-col bg-white border {{-- @if($orderDetail->payment_status == 'Pembayaran Berhasil') bg-green-100 border-2 border-green-500 @else bg-red-100 border-2 border-red-500 @endif --}} shadow-lg rounded-xl dark:bg-slate-900 dark:border-gray-800">
      <div class="p-4 md:p-5 flex gap-x-4">
        <div class="flex-shrink-0 flex justify-center items-center size-[46px] bg-gray-200 rounded-lg dark:bg-gray-800">
          <svg class="flex-shrink-0 size-5 text-gray-600 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M5 22h14" />
    ...
    <!-- End Card -->
    @elseif($orderDetail->payment_status == 'Pembayaran Berhasil' && $orderDetail->order_completed == null)
    <!-- Card -->
      <div class="flex flex-col bg-orange-100 border-2 border-orange-500 shadow-lg rounded-xl dark:bg-slate-900 dark:border-gray-800">
        <div class="p-4 md:p-5 flex gap-x-4">
          <div class="flex-shrink-0 flex justify-center items-center size-[46px] bg-orange-200 rounded-lg dark:bg-gray-800">
            <svg class="flex-shrink-0 size-5 text-gray-600 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M5 22h14" />
              <path d="M5 2h14" />
              <path d="M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22" />
          ...
          <div class="grow">
            ...
            <div class="mt-1 flex items-center gap-x-2">
              <h3 class="text-xl font-medium text-gray-800 dark:text-gray-200">
              {{ date('d F Y',strtotime($orderDetail->order_date . ' +3 days')) }}
              </h3>
            </div>
          </div>
        </div>
    ...
    <!-- Card -->
      <div class="flex flex-col bg-red-100 border-2 border-red-500 shadow-lg rounded-xl dark:bg-slate-900 dark:border-gray-800">
        <div class="p-4 md:p-5 flex gap-x-4">
          ...
          <div class="grow">
            <div class="flex items-center gap-x-2">
              <p class="text-xs uppercase tracking-wide text-black-500">
                Transaksi Selesai
              </p>
            </div>
            <div class="mt-1 flex items-center gap-x-2">
    ...
    <!-- End Card -->
    @elseif($orderDetail->order_status == 'Pengambilan Berhasil' && $orderDetail->order_completed != null)
    <!-- Card -->
      <div class="flex flex-col bg-green-100 border-2 border-green-500 shadow-lg rounded-xl dark:bg-slate-900 dark:border-gray-800">
        <div class="p-4 md:p-5 flex gap-x-4">
          <div class="flex-shrink-0 flex justify-center items-center size-[46px] bg-green-200 rounded-lg dark:bg-gray-800">
            <svg class="flex-shrink-0 size-5 text-gray-600 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M5 22h14" />
              <path d="M5 2h14" />
              <path d="M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22" />
    ...
    <div class="md:w-3/4">
      ...
      <div class="bg-white overflow-x-auto rounded-lg shadow-lg p-6 mb-4">
        ...
        <div class="flex justify-center items-center">
          <img src="{{ url('storage', $orderDetail->resep_dokter) }}" alt="Prescription image" class="max-w-full h-auto max-h-96">
        </div>
      </div>
      @endif
